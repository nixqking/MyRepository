...
<body>
	<div class="container"
		...
		<form class="form-signin" role="form" action="/sms/modifyStudent"
			method="post">
			<%-- <input type="hidden" name="sno" value="${sessionScope.student.sno}"> --%>
			<h2 class="form-signin-heading" style="text-align: center;">修改学生信息</h2>
			<div style="height: 10px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">StudentNumber</label><input type="text"
					readonly="readonly" value="${student.sno}" class="form-control"
					name="sno" placeholder="请输入学生学号" id="sno">
			</div>
			...
			<div class="form-group">
				<label class="sr-only">sname</label> <input type="text"
					value="${student.sname}" class="form-control" placeholder="请输入学生姓名"
					name="sname" id="sname">
			</div>
			<div style="height: 5px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">sex</label> <input type="text"
					value="${student.sex}" class="form-control" placeholder="请输入学生性别"
					name="sex" id="sex">
			</div>
			<div style="height: 5px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">sdept</label><input type="text"
					value="${student.sdept}" class="form-control" name="sdept"
					placeholder="请输入所属学院" id="sdept">
			</div>

			<div style="height: 5px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">classe</label><input type="text"
					value="${student.classe}" class="form-control" name="classe"
					placeholder="请输入所属班级" id="classe">
			</div>
