...
<body>
	<div class="container"
		...
		<form class="form-signin" role="form" action="/sms/modifyCourse"
			method="post">
			<%-- <input type="hidden" name="sno" value="${sessionScope.course.tno}"> --%>
			<h2 class="form-signin-heading" style="text-align: center;">修改课程信息</h2>
			<div style="height: 10px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">Number</label><input type="text"
					readonly="readonly" value="${course.cno}" class="form-control"
					name="cno" placeholder="请输入课程编号" id="cno">
			</div>
			...
			<div class="form-group">
				<label class="sr-only">cname</label> <input type="text"
					value="${course.cname}" class="form-control" placeholder="请输入课程名称"
					name="cname" id="cname">
			</div>
			<div style="height: 5px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">tno</label> <input type="text"
					value="${course.tno}" class="form-control" placeholder="请输入老师工号"
					name="tno" id="tno">
			</div>
			<div style="height: 5px; clear: both; display: block"></div>
