...
<body style="background-color: #F0EEF5">
	<div class="container" style="width: 100%; float: left;">
		<div id="div1" style="width: 100%; float: left;">
			<c:if
				test="${sessionScope.teacher!=null && '' ne sessionScope.teacher.getTname()}">
				<h1 style="text-align: center;">
					你好！<a href="/sms/queryTeacher" target="myfraame">${sessionScope.teacher.tname}</a>老师
				</h1>
			</c:if>
		</div>
						...
						<ul class="nav navbar-nav">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li class="divider"></li>
									<li><a href="/sms/queryStudentScore" target="myfraame">学生成绩</a></li>
									<li class="divider"></li>
									<li><a href="/sms/insertScore" target="myfraame">录入成绩</a></li>
									<li class="divider"></li>
									<li><a href="/sms/tpu" target="myfraame">修改密码</a></li>
									<li class="divider"></li>
