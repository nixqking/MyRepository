...
<body>
	<div class="container"
		...
		<form class="form-signin" role="form" action="/sms/modifyStudentScore"
			method="post">
			<%-- <input type="hidden" name="sno" value="${sessionScope.student.sno}"> --%>
			<h2 class="form-signin-heading" style="text-align: center;">修改成绩</h2>
			<div style="height: 10px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">StudentNumber</label><input type="text"
					value="${sc.sno}" class="form-control" name="sno"
					readonly="readonly" placeholder="请输入学生学号" id="sno">
			</div>
			...
			<div class="form-group">
				<label class="sr-only">CourseNumber</label> <input type="text"
					value="${sc.cno}" class="form-control" placeholder="请输入课程编号"
					name="cno" id="cno" readonly="readonly">
			</div>
			<div style="height: 10px; clear: both; display: block"></div>
			<div class="form-group">
				<label class="sr-only">Score</label> <input type="text"
					value="${sc.score}" class="form-control" placeholder="请输入课程成绩"
					name="score" id="score">
			</div>
			<div style="height: 10px; clear: both; display: block"></div>
